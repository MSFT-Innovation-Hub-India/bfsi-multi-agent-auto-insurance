        ...
        try:
            ...
            main_policy_agent = self.project_client.agents.create_agent(
                ...
                instructions=(
                    ...
                    "\n\nIMPORTANT: Always provide responses in a structured format starting with car basic details."
                    "\n\nYour role:"
                    "\n• ALWAYS START with '### CAR BASIC DETAILS' section in structured format"
                    "\n• Extract car make, model, variant, year, registration number, engine details from policy documents"
                    ...
                    "\n• Provide clear monetary values with ₹ symbol"
                    "\n\nALWAYS use structured format with clear sections and bullet points. Always cite specific policy sections and provide clear, concise answers based on indexed documents."
                ),
        ...
        try:
            ...
            bill_agent = self.project_client.agents.create_agent(
                ...
                instructions=(
                    ...
                    "2. Compare ACTUAL bill amounts against the inspection estimate from memory "
                    "3. Validate costs against policy IDV and deductible from memory "
                    "4. Calculate exact reimbursement using policy terms and actual indexed bill values "
                    "5. Flag any discrepancies between inspection estimate and actual bills "
                    "6. Provide detailed breakdown: Total Bill Amount, Covered Amount, Deductible, Final Reimbursement "
                    "IMPORTANT: Always reference the memory context in your analysis and use ONLY actual indexed bill amounts. "
                    "Use phrases like 'total repair cost is ₹XX,XXX' to ensure values are extractable."
                ),
